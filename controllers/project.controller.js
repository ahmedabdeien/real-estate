...
export const getProject = async (req, res) => {
  try {
    ...
    const unitQuery = { project: project._id, published: true };
    // Public visitors only see visible units; admins/authenticated users see all
    if (!req.user) unitQuery.isVisible = true;
