...
router.get('/pipeline',           hasPermission('customers.view'),   c.getPipeline);
...
router.patch('/:id/stage',        hasPermission('customers.update'), c.updateStage);
router.post('/:id/activities',    hasPermission('customers.update'), c.addActivity);
router.delete('/:id/activities/:actId', hasPermission('customers.update'), c.deleteActivity);
