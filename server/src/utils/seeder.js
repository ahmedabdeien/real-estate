...
const PLATFORM_ROLES = [
...

  {
    ...
    label: 'مدير الفوترة والاشتراكات',
    scope: 'platform',
    companyId: null,
    isSystem: true,
    color: '#0e7490',
    description: 'إدارة الاشتراكات والفواتير وخطط الأسعار',
    permissions: [
      'platform.billing.view',
  ...
  },
  {
    ...
    label: 'وكيل الدعم الفني',
    scope: 'platform',
    companyId: null,
    isSystem: true,
    color: '#b45309',
    description: 'عرض بيانات الشركات ومساعدة المستخدمين دون صلاحيات التعديل الحساسة',
    permissions: [
      'platform.companies.view',
  ...
  {
    name: 'platform-settings-manager',
    label: 'مدير إعدادات المنصة',
    scope: 'platform',
    companyId: null,
    isSystem: true,
    color: '#475569',
    description: 'تعديل إعدادات المنصة والثيم وسجل التحديثات',
    permissions: [
  ...
  },
  {
    ...
    label: 'مدير الأدوار والصلاحيات',
    scope: 'platform',
    companyId: null,
    isSystem: true,
    color: '#7e22ce',
    description: 'إنشاء وتعديل أدوار المنصة وإدارة أعضاء الفريق',
    permissions: [
      'platform.roles.view',
      'platform.roles.create',
      'platform.roles.update',
  ...
  },
  {
    ...
    isSystem: true,
    color: '#64748b',
    description: 'صلاحيات قراءة كاملة على جميع أقسام المنصة بدون أي تعديل',
    permissions: PLATFORM_PERMISSIONS
