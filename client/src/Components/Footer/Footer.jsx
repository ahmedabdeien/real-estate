  ...
  return (
    <footer className='text-sm'>
      ...
      <div className='p-8 grid md:grid-cols-3 gap-8 bg-white border-t text-black-300 dark:bg-stone-950'>
        {/* Work Hours Section */}
        <div>
          <h6 className='text-xl font-semibold mb-3 text-black'>Work Hours</h6>
          <ul className="space-y-1 text-gray-700 dark:text-gray-400/90">
            <li className='flex items-center'><span>Saturday</span><FaRegWindowMinimize className="mx-2"/><span>Thursday</span></li>
        ...
        {/* Quick Links Section */}
        <div>
          <h6 className='text-xl font-semibold mb-3 text-black'>Quick Links</h6>
          <ul className="space-y-2 text-gray-700 dark:text-gray-400/90">
            <li><Link to="/Home" className='hover:text-[#ff9505] transition-colors duration-200'>Home</Link></li>
            <li><Link to="/Project" className='hover:text-[#ff9505] transition-colors duration-200'>Projects</Link></li>
            <li><Link to="/About" className='hover:text-[#ff9505] transition-colors duration-200'>About</Link></li>
            <li><Link to="/Signin" className='hover:text-[#ff9505] transition-colors duration-200'>Sign In</Link></li>
          </ul>
        </div>

        {/* Contact Section */}
        <div>
          <h6 className='text-xl font-semibold mb-3 text-black'>Contact Us</h6>
          <ul className="space-y-1 text-gray-700 dark:text-gray-400/90">
