...
export default function SocialMediaLink() {
  return (
    ...
    <a href="http://www.facebook.com/elsarh.eg" target="_blank" rel="noopener noreferrer" className='bg-gray-100 text-[#033e8a] p-1 rounded-full'>
  <FaFacebookF/></a>
...
export function SocialMediaLinkTow(){
  return (
    <div className='flex items-center space-x-2 text-3xl text-white w-full'>
    <a href="http://www.facebook.com/elsarh.eg" target="_blank" rel="noopener noreferrer" className='bg-[#016FB9] rounded-full hover:opacity-90  p-2 flex justify-center items-center h-full w-1/4 transition-all'>
  <FaFacebookF/></a>
