...
const DashboardData = () => {
  ...
  const fetchDashboardData = async () => {
    ...
    try {
      ...
      const admins = statsData.users?.filter(u => u.isAdmin) || [];
  ...
  const chartData = [
    { name: 'مستخدمون', value: userStats.totalRegularUsers || 0 },
    { name: 'مدراء', value: userStats.totalAdmins || 0 },
    { name: 'وسطاء', value: userStats.totalBrokers || 0 }
  ];
