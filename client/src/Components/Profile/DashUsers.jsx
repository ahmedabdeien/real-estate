    ...
    return (
        <>
            ...
            <div className="p-4 bg-white dark:bg-gray-800 min-h-screen border-t">
                <div className='bg-[#004483]/20 px-4 py-6 mb-4 rounded-none'>
                    <h1 className="text-2xl font-bold text-gray-800 dark:text-white">User Management</h1>
                </div>
                <div className="mb-4 flex flex-wrap gap-2 items-center justify-between p-4 border rounded-none">
                                ...
                                {filteredUsers.map((user) => (
                                    <Table.Row key={user._id} className="bg-white dark:border-gray-700 dark:bg-gray-800">
                                        <Table.Cell className="flex items-center space-x-3">
                                            <img className="w-10 h-10 rounded-none" src={user.avatar} alt={user.name} />
                                            <div>
