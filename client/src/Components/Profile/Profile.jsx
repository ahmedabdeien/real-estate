...
export default function Profile(){
  ...
  return <>
    ...
    <div className='grid grid-cols-1 lg:gap-2 lg:grid-cols-2 px-10 p-4  '>

      <div className="col-span-1 lg:col-span-2 justify-center flex items-center text-2xl font-bold border-b-2 pb-3 mb-3 lg:mb-0">
        <h2>
      ...
      <div className="mt-8 border-t-2 pt-4 lg:mt-0 lg:border-none lg:pt-0"> 
          ...
          <svg className="absolute top-0 left-0 -z-10" id='patternId' width='100%' height='100%' xmlns='http://www.w3.org/2000/svg'><defs><pattern id='a' patternUnits='userSpaceOnUse' width='20' height='20' patternTransform='scale(1) rotate(65)'><rect x='0' y='0' width='100%' height='100%' fill='hsla(0,0%,100%,1)'/><path d='M3.25 10h13.5M10 3.25v13.5'  stroke='hsla(259, 0%, 92%, 1)' fill='none'/></pattern></defs><rect width='800%' height='800%' transform='translate(-1,-2)' fill='url(#a)'/>
