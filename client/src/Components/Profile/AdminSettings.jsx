            ...
            <div className="container mx-auto px-4 lg:px-12">
                    ...
                    <aside className="w-full lg:w-64 space-y-2">
                        {[
                            ...
                            <button
                                ...
                                className={`w-full flex items-center gap-4 px-6 py-4 rounded-sm text-sm font-bold uppercase tracking-widest transition-all
                ...
                `}
                    ...
                    <main className="flex-1">
                        <form onSubmit={handleSubmit} className="bg-white p-10 border border-slate-200 rounded-sm shadow-sm space-y-10">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                        <div className="space-y-2">
                                            ...
                                            <input type="text" id="siteName" value={formData.siteName} onChange={handleChange} className="w-full px-4 py-3 bg-slate-50 border border-slate-200 focus:ring-1 focus:ring-primary-500 outline-none rounded-sm transition-all text-sm" />
                                        </div>
                                        <div className="space-y-2">
                                            <label className="text-xs font-bold text-slate-400 uppercase tracking-widest">Logo URL</label>
                                            <input type="text" id="logo" value={formData.logo} onChange={handleChange} className="w-full px-4 py-3 bg-slate-50 border border-slate-200 focus:ring-1 focus:ring-primary-500 outline-none rounded-sm transition-all text-sm" />
                                        </div>
                                        <div className="space-y-2 lg:col-span-2">
                                            <label className="text-xs font-bold text-slate-400 uppercase tracking-widest">Google Maps API Key</label>
                                            <input type="text" id="mapsApiKey" value={formData.mapsApiKey} onChange={handleChange} className="w-full px-4 py-3 bg-slate-50 border border-slate-200 focus:ring-1 focus:ring-primary-500 outline-none rounded-sm transition-all text-sm" />
                                        </div>
                                    </div>
                                </div>
                            )}
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                        <div className="space-y-2">
                                            ...
                                            <div className="flex gap-4">
                                                <input type="color" id="primaryColor" value={formData.primaryColor || '#005B94'} onChange={handleChange} className="h-12 w-20 cursor-pointer rounded-sm border border-slate-200 p-1" />
                                                <input type="text" id="primaryColorText" value={formData.primaryColor} className="flex-1 px-4 py-3 bg-slate-50 border border-slate-200 rounded-sm text-sm" readOnly />
                                            </div>
                                        </div>
                                        <div className="space-y-2">
                                            <label className="text-xs font-bold text-slate-400 uppercase tracking-widest">Accent Color (Teal)</label>
                                            <div className="flex gap-4">
                                                <input type="color" id="accentColor" value={formData.accentColor || '#5BC1D7'} onChange={handleChange} className="h-12 w-20 cursor-pointer rounded-sm border border-slate-200 p-1" />
                                                <input type="text" id="accentColorText" value={formData.accentColor} className="flex-1 px-4 py-3 bg-slate-50 border border-slate-200 rounded-sm text-sm" readOnly />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                        <div className="space-y-2">
                                            ...
                                            <input type="text" id="contact.hotline" value={formData.contact.hotline} onChange={handleChange} className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-sm text-sm" />
                                        </div>
                                        <div className="space-y-2">
                                            <label className="text-xs font-bold text-slate-400 uppercase tracking-widest">Email</label>
                                            <input type="email" id="contact.email" value={formData.contact.email} onChange={handleChange} className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-sm text-sm" />
                                        </div>
                                        <div className="space-y-2">
                                            <label className="text-xs font-bold text-slate-400 uppercase tracking-widest">Phone</label>
                                            <input type="text" id="contact.phone" value={formData.contact.phone} onChange={handleChange} className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-sm text-sm" />
                                        </div>
                                    </div>
                                </div>
                            )}
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                            <div className="space-y-2">
                                                ...
                                                <input type="text" id="contact.maadiBranchAddress" value={formData.contact.maadiBranchAddress} onChange={handleChange} className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-sm text-sm" />
                                            </div>
                                            <div className="space-y-2">
                                                <label className="text-xs font-bold text-slate-400 uppercase tracking-widest">Google Maps Link</label>
                                                <input type="text" id="contact.maadiBranchLink" value={formData.contact.maadiBranchLink} onChange={handleChange} className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-sm text-sm" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="space-y-6">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                            <div className="space-y-2">
                                                <label className="text-xs font-bold text-slate-400 uppercase tracking-widest">Address</label>
                                                <input type="text" id="contact.beniSuefBranchAddress" value={formData.contact.beniSuefBranchAddress} onChange={handleChange} className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-sm text-sm" />
                                            </div>
                                            <div className="space-y-2">
                                                <label className="text-xs font-bold text-slate-400 uppercase tracking-widest">Google Maps Link</label>
                                                <input type="text" id="contact.beniSuefBranchLink" value={formData.contact.beniSuefBranchLink} onChange={handleChange} className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-sm text-sm" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                        <div className="space-y-2">
                                            ...
                                            <input type="text" id="socialLinks.facebook" value={formData.socialLinks.facebook} onChange={handleChange} className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-sm text-sm" />
                                        </div>
                                        <div className="space-y-2">
                                            <label className="text-xs font-bold text-slate-400 uppercase tracking-widest">Instagram</label>
                                            <input type="text" id="socialLinks.instagram" value={formData.socialLinks.instagram} onChange={handleChange} className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-sm text-sm" />
                                        </div>
                                        <div className="space-y-2">
                                            <label className="text-xs font-bold text-slate-400 uppercase tracking-widest">WhatsApp</label>
                                            <input type="text" id="socialLinks.whatsapp" value={formData.socialLinks.whatsapp} onChange={handleChange} className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-sm text-sm" />
                                        </div>
                                    </div>
                                </div>
                            )}
                            ...
                            {activeTab === 'translations' && (
                                <div className="space-y-6">
                                    ...
                                    <div className="bg-blue-50 text-blue-800 p-4 rounded-sm text-sm mb-4">
                                    ...
                                    <div className="space-y-4 max-h-[600px] overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-slate-200">
                                        {['welcome', 'contact_us', 'about_desc', 'quick_links', 'working_hours', 'saturday', 'thursday', 'friday', 'closed', 'send_a_message'].map((key) => (
                            ...
                            <div className="flex justify-end pt-6 border-t border-slate-100">
                                <button
                                    type="submit"
                                    disabled={loading}
                                    className="bg-primary-600 text-white px-10 py-4 rounded-sm font-bold uppercase tracking-widest hover:bg-primary-700 transition-all flex items-center gap-3 shadow-lg disabled:opacity-50"
                                >
                                    <FiSave />
