    ...
    <div dir="rtl" className="bg-[var(--background)] transition-colors duration-500 overflow-hidden">
      ...
      <section className="relative h-[50vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="container relative z-10 text-center px-6">
          <span className="inline-block px-4 py-1 bg-primary-600 text-white rounded-full text-[10px] font-black tracking-widest mb-6">
            تاريخ من الإنجاز
          </span>
              ...
              <div className="flex gap-3">
                {visions.map((v, i) => (
                  <button
                    ...
                    className={`px-8 py-2.5 rounded-full font-black text-xs transition-all ${activeVision === i
      ...
      <section className="py-24 container mx-auto px-6 lg:px-12 text-center">
        <span className="text-primary-600 font-black uppercase text-[10px] tracking-widest">فريق التميز</span>
        <h2 className="text-3xl md:text-5xl font-black text-slate-900 mt-4 mb-16 font-heading">القيادة خلف نجاحاتنا</h2>
        <TeamMembers />
      </section>
