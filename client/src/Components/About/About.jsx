  ...
  return (
    <section className="">
      <div className="w-full md:rounded-b-2xl overflow-hidden h-80 bg-fixed bg-cover bg-zinc-600 bg-[url(https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8ODZ8fHJlYWwlMjBzdGF0ZXxlbnwwfHwwfHx8MA%3D%3D)]">
        <div className="w-full h-full bg-[#1282a2]/80 dark:bg-gray-600/80 flex justify-center items-center">
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 container m-auto py-3 lg:p-7 ">
       <div className=" flex justify-center items-center p-3 border dark:border-gray-600">
         <div className="bg-[#001f54] p-2 border-b-4 border-[#c98d00]">
            <img src={elsarhLoge} alt="elsarhLoge" className="w-72 " />
         </div>
       </div>
       <div className="w-full  text-gray-600 dark:text-gray-200 lg:col-span-2 p-2 ">
        <div>
          <h4 className="text-2xl font-bold text-gray-900 dark:text-gray-200">
          El Sarh Real Estate Investment Company
          </h4>
          <p className=" text-zinc-900 dark:text-gray-400  py-5 ">
