...
const VERSIONS = [
  {
    version: "2.9.0",
    date: "2026-05-17",
    title: "إصلاح تسجيل العملاء ومنتقي التاريخ",
    items: [
  ...
  },
  {
    version: "2.8.0",
    date: "2026-05-17",
    title: "تعديل المشروع مباشرة من صفحة التفاصيل",
    items: [
  ...
  },
  {
    version: "2.7.0",
    date: "2026-05-17",
    title: "صفحة تسجيل العملاء وإعادة تصميم تفاصيل المشروع",
    items: [
  ...
  },
  {
    version: "2.6.0",
    date: "2026-05-17",
    title: "الإشعارات وسلة مهملات الصفوف",
    items: [
  ...
  },
  {
    version: "2.5.0",
    date: "2026-05-17",
    title: "سلة المحذوفات وتحسينات سجل النشاط وتجربة المستخدم",
    items: [
