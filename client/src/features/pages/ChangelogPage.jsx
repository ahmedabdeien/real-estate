...
const CHANGELOG = [
  {
    ...
    date: '2026-06-12',
    label: 'major',
    title: 'إصلاح جذري للعزل + صفحات المنصة + تحكم Navbar/Footer',
    summary: 'إصلاح السبب الجذري لتداخل المنصة مع الشركات، صفحات منصة منفصلة، الثيم العام للمنصة فقط، وخيارات إظهار شريط التنقل والفوتر لكل صفحة.',
    entries: [
      { type: 'fix', text: 'السبب الجذري للتداخل: السوبر أدمن كان يسقط تلقائياً داخل سياق شركة حسابه — الآن يعمل في سياق المنصة دائماً إلا بطلب صريح' },
      { type: 'fix', text: 'السوبر أدمن لم يكن قادراً على إنشاء صفحات منصة إطلاقاً (companyId إجباري) — أصبحت صفحات المنصة كيان مستقل' },
      { type: 'fix', text: 'حسابات السوبر أدمن لا تظهر نهائياً في قوائم مستخدمي الشركات' },
      { type: 'feature', text: 'خيار إظهار شريط التنقل (Navbar) والفوتر الرسميين في أي صفحة من إعدادات الصفحة' },
      { type: 'feature', text: 'بلوك صورة ونص — قسم بنمط Odoo بصورة جانبية وزر اختياري، متجاوب تلقائياً' },
      { type: 'feature', text: 'بلوك خط زمني — محطات رحلة شركتك بتواريخ ونقاط ملونة' },
      { type: 'feature', text: 'بحث فوري في قائمة الصفحات بالعنوان أو الرابط' },
      { type: 'feature', text: 'نسخ صفحة كاملة بضغطة واحدة (بمحتواها وإعداداتها) + زر فتح الصفحة المنشورة' },
      { type: 'improvement', text: 'الثيم العام أصبح للمنصة فقط — الشركات تستخدم «مظهري الشخصي» المحفوظ في المتصفح' },
      { type: 'improvement', text: 'إجمالي البلوكات 29 بلك في 4 أقسام — كلها متجاوبة وبأيقونات FA6' },
    ],
  },
  {
    version: '5.1.0',
    date: '2026-06-12',
    label: 'major',
    title: 'الفصل التام للصلاحيات + الثيم الشخصي + إعدادات الصفحات',
    summary: 'إعادة هيكلة نظام الأدوار لـ3 مستويات معزولة برمجياً، ثيم شخصي لكل مستخدم محفوظ في المتصفح مع وضع ليلي، وإعدادات SEO وتخطيط لكل صفحة على حدة.',
    entries: [
      { type: 'feature', text: '3 مستويات أدوار معزولة تماماً: منصة (Platform) / شركة (Company) / محتوى (Page) — لا تداخل برمجياً' },
      { type: 'feature', text: 'أدوار المحتوى الجديدة — محرر، صانع محتوى، مشاهد بصلاحيات صفحات ووسائط دقيقة' },
      { type: 'feature', text: 'فلترة الصلاحيات على مستوى الدور — أي صلاحية خارج نطاق الدور تُرفض تلقائياً' },
      { type: 'feature', text: 'الثيم الشخصي — كل مستخدم يختار ألوانه (Color Picker) من أيقونة في الشريط العلوي' },
      { type: 'feature', text: 'الوضع الليلي — بزر واحد، يُحفظ ويُسترجع تلقائياً' },
      { type: 'feature', text: 'حفظ تفضيلات المستخدم في LocalStorage — تبقى بعد تحديث الصفحة وإعادة الدخول' },
      { type: 'feature', text: 'إعدادات صفحة كاملة في المحرر: عنوان SEO، وصف Meta، كلمات مفتاحية، OG Image، noindex' },
      { type: 'feature', text: 'تخطيط لكل صفحة: لون الخلفية، عرض كامل/صندوق، اتجاه RTL/LTR، وCSS مخصص للصفحة' },
      { type: 'improvement', text: 'صلاحيات دقيقة لكل عملية على الصفحات (عرض/إنشاء/تعديل/نشر/حذف) بدل صلاحية واحدة' },
      { type: 'improvement', text: 'تبويبات نطاق في صفحة الأدوار: أدوار الشركة / أدوار المحتوى' },
      { type: 'fix', text: 'إصلاح تداخل الأدوار — migration تلقائي يصنف الأدوار القديمة في نطاقها الصحيح' },
      { type: 'fix', text: 'تنظيف تلقائي للصفحات المحفوظة ببلوكات قديمة — لا تكسر المحرر بعد الآن' },
      { type: 'fix', text: 'أدوار المنصة لا يمكن لأي مستخدم شركة لمسها نهائياً' },
    ],
  },
  {
    version: '4.0.0',
